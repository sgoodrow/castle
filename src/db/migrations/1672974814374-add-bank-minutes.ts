...
export class addBankMinutes1672974814374 implements MigrationInterface {
    name = 'addBankMinutes1672974814374'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "bank_hour" ("id" SERIAL NOT NULL, "userId" character varying NOT NULL, "day" "public"."bank_hour_day_enum" NOT NULL, "hour" real NOT NULL, CONSTRAINT "PK_e4f0bb9596fa3c66b3c81ea0a4f" PRIMARY KEY ("id"))`);
