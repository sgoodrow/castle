...
Guards are voted in by officers. Each applicant must be approved by 3 officers and not be opposed by any. This process typically takes a less than a week. Officers are the only players who see applications. Applications and their discussion are deleted permanently once voted on.`,
    });
