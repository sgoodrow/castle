...
Tell them to introduce themselves in our Discord (https://tinyurl.com/castle-discord). A guard will give them appropriate Discord roles.

**I need an invite in-game, how do I get one?**
Hit the button to add yourself to the invite list. A Guard or Officer will contact you in the future when they're doing invites in-game.
