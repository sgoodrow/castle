...
export class OdkpGetSubcommand extends Subcommand {
  ...
  public async execute(
    ...
    try {
      ...
      const output = await openDkpService.getCharacterSummary(character);
      if (!character) {
...
export const odkpSummarySubcommand = new OdkpGetSubcommand(
  "summary",
  "Gets DKP summary for a character",
  false
);
