...
**Knight Application**
> 1. Please describe what motivates you to volunteer as a Knight of <Castle>. Which aspects of being a Knight are you interested in or willing to help with?
> 
> 2. Knights must set a shining example of the guild while interacting with prospective recruits. Are you willing to hold yourself to the highest standards of decorum while representing Castle to new members?
> 
...
Knights are voted in by officers. Each applicant must be approved by 3 officers and not be opposed by any. This process typically takes a less than a week. Officers are the only players who see applications. Applications and their discussion are deleted permanently once voted on.`,
    });
