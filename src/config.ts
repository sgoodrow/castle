...
export const {
  ...
  SPAWN_TIMER_DATABASE_URL,
  TIMER_COMMAND_CHANNEL_ID,
  TIMER_CHANNEL_ID,
  ...
  // Spawn timers
  SPAWN_TIMER_DATABASE_URL: string;
  TIMER_COMMAND_CHANNEL_ID: string;
  TIMER_CHANNEL_ID: string;
  TIMER_ALERT_CHANNEL_ID: string;
